...
const Hero = () => {
  ...
  useEffect(() => {
    const checkScreenSize = () => {
      setIsSmallScreen(window.innerWidth <= 768); // Adjust width as needed
    };
    checkScreenSize();
      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm <span className="text-[#CD1A2F]">Vivek Tripathi</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I work as a Java Backend Developer and Data Analyst.{" "}
            <br className="sm:block hidden" />
            <p style={{ fontSize: 15 }}>
              Building scalable backends with Java & Spring Boot while
